        ...
        <form method="post" action="update_record.php">
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control" id="mobileNumber" name="mobileNumber"
                    value="<?php echo htmlspecialchars($mobileNumber); ?>" placeholder="Enter Mobile Number" required>
            </div>
            <div class="form-group">
                <label for="homeAddress">Home Address</label>
                <input type="text" class="form-control" id="homeAddress" name="homeAddress"
                    value="<?php echo htmlspecialchars($homeAddress); ?>" placeholder="Enter Home Address" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth"
                    value="<?php echo htmlspecialchars($formattedDateOfBirth); ?>" required>
            </div>
            <div class="form-group">
